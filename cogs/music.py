...
class Music(commands.Cog):
    ...
    @commands.command(name='leave', aliases=['quit', 'disconnect'])
    async def leave(self, ctx):
        """Make Bounty leave current voice channel"""
    ...
    @commands.command(name='now_playing', aliases=['np', 'current', 'currentsong', 'playing', 'status'])
